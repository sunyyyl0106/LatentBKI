...
class voxel_dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        _, inds, inverse_map = sparse_quantize(pc_, 1, return_index=True, return_inverse=True) # remove duplicate points within voxel
        ...
        # added for latentbki
        data_dict['global_pose'] = data['global_pose']
        data_dict['scene_id'] = data['scene_id']
        data_dict['frame_id'] = int(data['frame_id'])
