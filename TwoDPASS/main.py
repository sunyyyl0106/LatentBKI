...
if __name__ == '__main__':
    ...
    my_model = model_file.get_model(configs) ######## get model ############
    ...
    if configs.checkpoint is not None:
        ...
        if configs.fine_tune or configs.test or configs.pretrain2d:
            my_model = my_model.load_from_checkpoint(configs.checkpoint, config=configs, strict=(not configs.pretrain2d)) ######### load model ##########
        else:
